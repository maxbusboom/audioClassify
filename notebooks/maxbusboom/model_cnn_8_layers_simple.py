...
class CNNModel_8Layers(UrbanSoundBase):
    """
    Model : 6 CNN Layers, 2NN Layers
    Layer Size : 16, 16, 32, 32, 64, 64, _256, _10
    Drop Outs : False, True, False, True, False, True
    Drop Values : _, 0.3, _, 0.3, _, 0.3
    Max Pool : False, True, False, True, False, True
    Max Pool Values : _, 2, _, 2, _, 2
    """
